...
What to do: reword the sentence without the literal string (for example \xABthe kickoff does not carry the closing keyword\xBB instead of naming it). If you really do want to close the issue, make it explicit: \`gh issue close <n> --reason completed\`.`
  );
}
