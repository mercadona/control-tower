...
* check published ports in the effective Compose configuration ([#558](https://github.com/mercadona/control-tower/issues/558)) ([bb750f9](https://github.com/mercadona/control-tower/commit/bb750f925ad38a7c79b2e5cffc0b7ba24540f7b3))
* prepare Django assets before the worktree baseline ([#561](https://github.com/mercadona/control-tower/issues/561)) ([772d857](https://github.com/mercadona/control-tower/commit/772d85722728ef7d10ed0e22f399c7a5471ddf21))
...
* the backend reaches the operating system through one declared border, with a coverage baseline, a ledger and a ratchet ([#569](https://github.com/mercadona/control-tower/issues/569)) ([586570b](https://github.com/mercadona/control-tower/commit/586570baf720580f6093d19e3f470f9cef93a393))
...
* **backend:** /active-plans answers whether a slice would accept a change, instead of leaving the caller to guess ([#469](https://github.com/mercadona/control-tower/issues/469)) ([2ffbaad](https://github.com/mercadona/control-tower/commit/2ffbaadb072d59479dc031f04e695a80c4959cbe))
* **backend:** a change a busy slice cannot take is kept, goes out by itself, and the person is told ([#474](https://github.com/mercadona/control-tower/issues/474)) ([583833d](https://github.com/mercadona/control-tower/commit/583833d27ac340efee81e5d48c1c8d1ec98b2db8))
...
* **backend:** the headless worker releases the terminal it inherited, so a crashed backend leaves no live claude behind ([#467](https://github.com/mercadona/control-tower/issues/467)) ([7b8390a](https://github.com/mercadona/control-tower/commit/7b8390a0e6c1d5c35d85c99cef3eb553d8549618))
