...
const CLAUDE_UNKNOWN = { tool: 'claude', installed: true, session: 'unknown', fix: 'claude, then /login' }
...
const unknownSession = () =>
  bodyOf({ ready: true, tools: [GH_READY, CLAUDE_UNKNOWN], metricsDelivery: DELIVERY_DISABLED })
