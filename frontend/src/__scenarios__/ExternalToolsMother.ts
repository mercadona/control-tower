...
const GIT_UNKNOWN = { tool: 'git', installed: true, session: 'unknown', fix: 'install ssh, then add an SSH key to your GitHub account' }
...
const unknownSession = () =>
  bodyOf({ ready: true, tools: [GH_READY, GIT_UNKNOWN], metricsDelivery: DELIVERY_DISABLED })
