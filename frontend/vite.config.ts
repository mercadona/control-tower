...
const API_PATHS = ['/start-plan', '/recover-plan', '/cleanup-plan', '/plan-events', '/implement-progress', '/implement-history', '/active-plans', '/external-tools', '/sessions', '/coordinating-session', '/groom-session', '/session-hooks', '/spec-freeze', '/spec-reslicing', '/epic-groom', '/epic-promotion']
