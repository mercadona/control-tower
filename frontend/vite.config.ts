...
const API_PATHS = ['/recover-plan', '/cleanup-plan', '/work-progress', '/implement-history', '/active-plans', '/external-tools', '/sessions', '/slices', '/coordinating-session', '/groom-session', '/session-hooks', '/spec-freeze', '/spec-reslicing', '/epic-groom', '/epic-promotion', '/milestone-progress']
