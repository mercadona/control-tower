...
const API_PATHS = ['/start-plan', '/plan-events', '/implement-plan', '/implement-progress', '/implement-history', '/active-plans', '/external-tools', '/sessions', '/coordinating-session', '/session-hooks', '/spec-freeze', '/epic-groom', '/epic-promotion']
